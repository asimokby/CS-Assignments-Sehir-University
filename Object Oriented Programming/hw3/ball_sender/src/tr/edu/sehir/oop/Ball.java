...
public class Ball  implements Serializable {
    ...
    public static boolean  wasRefrected = true; // initially it is true because the ball starts from a random place
    /**
    ...
    public void moveOneStepWithCollisionDetection(ContainerBox box) {
        ...
        if (x < ballMinX) {
            Ball.wasRefrected = true;
            System.out.println("left");
            speedX = -speedX; // Reflect along normal
            x = ballMinX;

        }   // Re-position the ball at the edge
//        } else if (x >= (ballMaxX  + ( radius)) ) { //no reflection for this one on the right side
