...
public class Ball {
     ...
     */
    public Ball(int x, int y, float radius, float speed, float angleInDegree,
                Color color) {
        this.x = x;
        this.y = y;
    ...
    //default constructor to be used by the driven classes
    public Ball() {
    ...
    public void moveOneStepWithCollisionDetection(ContainerBox box) {
        ...
        int ballMaxY = Math.round(box.maxY - radius );
